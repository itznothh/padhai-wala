        ...
        <div data-delay="700" className="flex items-center gap-10 mt-16">
          {STATS.map((s, i) => (
            <div key={i} className="text-center relative">
              {i > 0 && (
                <span
                  className="absolute -left-5 top-1/2 -translate-y-1/2 h-6 w-px"
      ...
      <section className="px-6 pb-24 max-w-2xl mx-auto w-full relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-sm mt-3 max-w-sm mx-auto" style={{ color: 'var(--text-muted)' }}>
            Each agent specializes in one part of the journey — together they cover everything.
          </p>
        </div>
          ...
          {FEATURES.map((f, i) => (
            <div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = '0 4px 24px rgba(247,97,10,0.1)'
              }}
              onMouseLeave={e => {
